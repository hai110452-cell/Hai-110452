...
function App() {
  ...
  const sidebarContent = (
    <>
      <MucSidebar Icon={LayoutDashboard} nhan="Bảng điều khiển" kichHoat={true} />
      <MucSidebar Icon={BookOpen} nhan="Quản lý môn học" />
      <MucSidebar Icon={Users} nhan="Danh sách sinh viên" />
      <MucSidebar Icon={Settings} nhan="Cài đặt hệ thống" />
    </>
  );

  return (
    <BoKhungChinh sidebar={sidebarContent}>
